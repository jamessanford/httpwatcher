### httpwatcher example binary

This example `httpwatcher` is a variant of [gover](https://github.com/jamessanford/gover)
hooked up to the [httpwatcher](https://github.com/jamessanford/httpwatcher) library.
